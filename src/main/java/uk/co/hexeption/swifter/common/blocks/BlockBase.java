...
import uk.co.hexeption.swifter.common.tileEntities.TileEntityBase;
import uk.co.hexeption.swifter.common.utils.IBlockRenderer;
import uk.co.hexeption.swifter.common.utils.Platfrom;
import uk.co.hexeption.swifter.common.utils.TileHelper;
...
public abstract class BlockBase extends Block implements IBlockRenderer {
    ...
    public String getUnlocalizedName() {
        ...
        String blockName = getUnwrappedUnloacalizedName(super.getUnlocalizedName());
    ...
    private String getUnwrappedUnloacalizedName(String unlocalizedName) {
    ...
    public void registerBlockItemRenderer() {
        ...
        for (ItemStack itemStack : subBlocks) {
            ...
            ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(this), itemStack.getItemDamage(), new ModelResourceLocation(resourcePath, Platfrom.getPropertyString(blockState.getProperties())));
        }
    }
}
